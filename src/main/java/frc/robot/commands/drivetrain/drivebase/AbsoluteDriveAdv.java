...
public class AbsoluteDriveAdv extends Command
{
   ...
   */
  public AbsoluteDriveAdv(DrivetrainSubsystem swerve, DoubleSupplier vX, DoubleSupplier vY, DoubleSupplier headingAdjust,
  ...
  public void execute()
  {
    ...
    {
      resetHeading = true;
      swerve.drive(translation, (ControllerConstants.TURN_CONSTANT * -headingAdjust.getAsDouble()), true);
    } else
    {
